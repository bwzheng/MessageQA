function PouchService() {
  this.db = new PouchDB('messageqa_local_database');
}

angular.module('messageQA.services', []).service('pouchService', PouchService)
...
.factory('Professionals', function() {
    ...
    .factory('Advocates', function() {
          ...
          },
          {
            id: 102,
            name: 'Chris Baier',
            email: 'cbaier@chris-baier.com',
            price: 0,
            face: 'img/Chris.jpg',
            intro: "Chris is a parent of a child with OCD and runs an OCD support group for Parents of kids with OCD in Brooklyn, NY. He is co-producing a film about kids with OCD called UNSTUCK and is an "OCD Guardian" for Wisdo.com."
          }]
